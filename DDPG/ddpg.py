...
class Actor(nn.Module):  # nn是神经网络相关东西，这个模块的使用和具体构造还需在了解
    def __init__(self, n_states, n_actions, hidden_dim, init_w=3e-3):
        ...
        self.linear1.weight.data.uniform_(-init_w, init_w)  # 应该是机器学习里面的概念，权重怎么定？
        self.linear1.bias.data.uniform_(-init_w ,init_w)
        self.linear2.weight.data.uniform_(-init_w, init_w)  # 应该是机器学习里面的概念，权重怎么定？
...
class DDPG:
    ...
    def update(self):
        ...
        # self.loss.append(policy_loss)
        # print('aaaaaaaaaaa', self.loss)
